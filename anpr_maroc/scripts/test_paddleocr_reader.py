...
Usage:
    python -m anpr_maroc.scripts.test_paddleocr_reader --image data/sample_plates/2.jpg
    python -m anpr_maroc.scripts.test_paddleocr_reader --image data/sample_plates/2.jpg --segment
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run PaddleOCRReader on a plate image.")
    ...
    reader = PaddleOCRReader(gpu=args.gpu, conf_threshold=args.threshold)
